...
public:
   ...
   */
	...
	double overHead;
	double sentPackets;
	double sentHelloPackets;
	double sentHelloIntervals;
	double Va;
	void SetHelloInterval (void);
	double lastPktRecTime;
	double dropCount;
	double LCR;
	double helloUpdateTime;
	std::vector<double> overHeadPerSec;
	double recOverHead;
	std::vector<double> recOverHeadPerSec;
